...
// v2: cambia el nombre del caché a propósito — así, en el primer momento en
// que cada teléfono vuelva a abrir la app (o el ícono de Admin/Cocina en su
// pantalla de inicio) con internet, se descarta de una vez el "cascarón"
// viejo guardado (que traía la rayita beige y el manifest equivocado) en
// vez de esperar a que se actualice solo en segundo plano.
const CACHE_NAME = 'zano-shell-v2';
const APP_SHELL = [
  './',
  './index.html',
  './manifest.json',
